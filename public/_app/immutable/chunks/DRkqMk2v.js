var ft=Object.defineProperty;var mt=(T,_,z)=>_ in T?ft(T,_,{enumerable:!0,configurable:!0,writable:!0,value:z}):T[_]=z;var nt=(T,_,z)=>mt(T,typeof _!="symbol"?_+"":_,z);import{g as kt}from"./CqkleIqs.js";function wt(T,_){for(var z=0;z<_.length;z++){const y=_[z];if(typeof y!="string"&&!Array.isArray(y)){for(const A in y)if(A!=="default"&&!(A in T)){const M=Object.getOwnPropertyDescriptor(y,A);M&&Object.defineProperty(T,A,M.get?M:{enumerable:!0,get:()=>y[A]})}}}return Object.freeze(Object.defineProperty(T,Symbol.toStringTag,{value:"Module"}))}var Z={exports:{}},xt=Z.exports,st;function bt(){return st||(st=1,function(T,_){(function(z,y){T.exports=y()})(xt,function(){function z(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let y={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const A=/[&<>"']/,M=new RegExp(A.source,"g"),B=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,rt=new RegExp(B.source,"g"),at={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},J=h=>at[h];function b(h,n){if(n){if(A.test(h))return h.replace(M,J)}else if(B.test(h))return h.replace(rt,J);return h}const ot=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function Q(h){return h.replace(ot,(n,t)=>(t=t.toLowerCase())==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):"")}const lt=/(^|[^\[])\^/g;function k(h,n){h=typeof h=="string"?h:h.source,n=n||"";const t={replace:(e,s)=>(s=(s=s.source||s).replace(lt,"$1"),h=h.replace(e,s),t),getRegex:()=>new RegExp(h,n)};return t}const ct=/[^\w:]/g,ut=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function W(h,n,t){if(h){let e;try{e=decodeURIComponent(Q(t)).replace(ct,"").toLowerCase()}catch{return null}if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}n&&!ut.test(t)&&(t=function(e,s){O[" "+e]||(pt.test(e)?O[" "+e]=e+"/":O[" "+e]=D(e,"/",!0)),e=O[" "+e];const a=e.indexOf(":")===-1;return s.substring(0,2)==="//"?a?s:e.replace(dt,"$1")+s:s.charAt(0)==="/"?a?s:e.replace(ht,"$1")+s:e+s}(n,t));try{t=encodeURI(t).replace(/%25/g,"%")}catch{return null}return t}const O={},pt=/^[^:]+:\/*[^/]*$/,dt=/^([^:]+:)[\s\S]*$/,ht=/^([^:]+:\/*[^/]*)[\s\S]*$/,N={exec:function(){}};function K(h,n){const t=h.replace(/\|/g,(s,a,r)=>{let i=!1,o=a;for(;--o>=0&&r[o]==="\\";)i=!i;return i?"|":" |"}).split(/ \|/);let e=0;if(t[0].trim()||t.shift(),t.length>0&&!t[t.length-1].trim()&&t.pop(),t.length>n)t.splice(n);else for(;t.length<n;)t.push("");for(;e<t.length;e++)t[e]=t[e].trim().replace(/\\\|/g,"|");return t}function D(h,n,t){const e=h.length;if(e===0)return"";let s=0;for(;s<e;){const a=h.charAt(e-s-1);if(a!==n||t){if(a===n||!t)break;s++}else s++}return h.slice(0,e-s)}function V(h,n){if(n<1)return"";let t="";for(;n>1;)1&n&&(t+=h),n>>=1,h+=h;return t+h}function F(h,n,t,e){const s=n.href,a=n.title?b(n.title):null,r=h[1].replace(/\\([\[\]])/g,"$1");if(h[0].charAt(0)!=="!"){e.state.inLink=!0;const i={type:"link",raw:t,href:s,title:a,text:r,tokens:e.inlineTokens(r)};return e.state.inLink=!1,i}return{type:"image",raw:t,href:s,title:a,text:b(r)}}class j{constructor(n){this.options=n||y}space(n){const t=this.rules.block.newline.exec(n);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(n){const t=this.rules.block.code.exec(n);if(t){const e=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?e:D(e,`
...
`),l.markdown=c[0]&&typeof c[0].getAttribute("data-markdown")=="string"),t.postMessage(JSON.stringify(l),"*")}function a(i){if(function(o){try{return window.location.origin===o.source.location.origin}catch{return!1}}(i))try{let o=JSON.parse(i.data);o&&o.namespace==="reveal-notes"&&o.type==="connected"?(clearInterval(h),r()):o&&o.namespace==="reveal-notes"&&o.type==="call"&&function(c,d,l){let u=n[c].apply(n,d);t.postMessage(JSON.stringify({namespace:"reveal-notes",type:"return",result:u,callId:l}),"*")}(o.methodName,o.arguments,o.callId)}catch{}}function r(){n.on("slidechanged",s),n.on("fragmentshown",s),n.on("fragmenthidden",s),n.on("overviewhidden",s),n.on("overviewshown",s),n.on("paused",s),n.on("resumed",s),s()}return{id:"notes",init:function(i){n=i,/receiver/i.test(window.location.search)||(window.location.search.match(/(\?|\&)notes/gi)!==null?e():window.addEventListener("message",o=>{if(!t&&typeof o.data=="string"){let d;try{d=JSON.parse(o.data)}catch{}d&&d.namespace==="reveal-notes"&&d.type==="heartbeat"&&(c=o.source,t&&!t.closed?t.focus():(t=c,window.addEventListener("message",a),r()))}var c}),n.addKeyBinding({keyCode:83,key:"S",description:"Speaker notes view"},function(){e()}))},open:e}}})}(Z)),Z.exports}var it=bt();const yt=kt(it),Tt=wt({__proto__:null,default:yt},[it]);export{Tt as n};
