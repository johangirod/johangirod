...
<section>
	...
	<section data-auto-animate>
		...
		<pre data-id="code-animation-zdadahjzo"><code
	...
	{#each [0, 1, 1.1, 1.2, 2, 3, 4] as i}
		<section data-auto-animate>
			...
			{#if i >= 2 && i < 3}
				...
				<pre data-id="code-animation"><code class="language-js" data-trim data-noescape
						>{#if i === 2}<script type="text/template">
...
<section>
	...
	<section data-auto-animate>
		...
		<div>
			<h3>Par ordre croissant (nombre)</h3>
			<pre data-id="sort-asc"><code class="language-js" data-trim data-noescape
					><script type="text/template">
						const number = [1, 2, 11, 3];
						number.sort((a, b) => {
							if (a < b) return -1;
